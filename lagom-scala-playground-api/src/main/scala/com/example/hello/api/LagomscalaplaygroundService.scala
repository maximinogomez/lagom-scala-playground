...
object LagomscalaplaygroundService  {
  val TOPIC_NAME = "greetings"
}

// The lagom-scala-playground service interface. 
// This describes everything that Lagom needs to know about how to serve and consume the LagomscalaplaygroundService.

trait LagomscalaplaygroundService extends Service {
  ...
  override final def descriptor = {
    import Service._
    // @formatter:off
    named("lagom-scala-playground")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(LagomscalaplaygroundService.TOPIC_NAME, greetingsTopic)
